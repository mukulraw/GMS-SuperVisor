...
*/
    ...
    private void hitApi(String serial_no) {
        RestAdapter restAdapter = new RestAdapter.Builder()
                .setEndpoint(" http://115.118.242.137:5000/GuardIT-RWS/rest/myresource/")
            ...
            public void success(ScanNFCPojo buddypojo, Response response) {
                ...
                try {
                    ...
                    if (!prefs.getPreferencesString(ScanGuard.this, "shift_id").equals(buddypojo.getShiftId())) {
                        ...
                        new DownloadMusicfromInternet().execute("http://115.118.242.137:5000/GuardIT-RWS/rest/myresource/profilepic?emp_id=" + buddypojo.getEmp_id());
